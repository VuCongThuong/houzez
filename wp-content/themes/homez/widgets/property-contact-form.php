			    ...
			    <div id="click-popup-contact" class="mfp-hide">
			    	<div class="popup-property-contact">
					    ...
					    <form method="post" action="?" class="contact-form-wrapper form-theme">
			                ...
			                if ( $whatsapp ) {
			                    ?>
			                    <a class="btn btn-green btn-outline btn-whatsapp w-100" href="whatsapp://send?abid=<?php echo esc_attr($whatsapp); ?>"><?php esc_html_e('Whatsapp', 'homez'); ?><i class="flaticon-up-right-arrow next"></i></a>
			                    <?php
			                }
			                ?>
					    </form>
